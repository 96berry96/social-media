...
export default {
  ...
  methods: {
    ...
    handelRequests(status, pk){
      console.log('handle requests ', status);
      ...
      >
        ...
        >
          ...
          <div class="ml-6 space-x-4">
            <button class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg" @click="handelRequests('accepted', friendshipRequest.created_by.id)">Accept</button>
            <button class="inline-block py-4 px-6 bg-red-600 text-white rounded-lg" @click="handelRequests('rejected', friendshipRequest.created_by.id)">Reject</button>
          </div>
        </div>
      </div>
    </div> 
